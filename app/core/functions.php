...
// Funktion löscht Bilder, wenn admin z.B. einen User/Post mit Bildern löscht
...
// Vereinfachte Version von header()
...
// Speichert den Wert im Feld nach dem Neuladen
...
// Sucht nach einem Bild, falls es kein gibt - lädt ein bestimmtes Bild hoch
...
// Wandelt string values in url um
...
// Vermeidet Zeichen und wandelt sie um
function esc($str)
{
	return htmlspecialchars($str ?? '');
}

// Gewährt eingeloggten Users Zugriff
function authenticate($row)
{
	$_SESSION['USER'] = $row;
}

// Gibt Attribute von Users zurück
function user($key = '')
{
	if(empty($key))
...
// Überprüft, ob user momentan eingeloggt ist
function logged_in()
{
...
// Schafft Tabellen und Attributen für Datenbank
//create_tables();
function create_tables()
{
	...
	$query = "create table if not exists reservations(
		...
		pets int null,
		date datetime default current_timestamp,
		status_reservation varchar(10) not null,
...
// Verkleinert Bilder für News-Beiträge
