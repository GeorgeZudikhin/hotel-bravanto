  <?php 
    ...
    if($action == 'add')
    {
        if(!empty($_POST))
        {
          ...
          {
            $errors['category'] = "Please enter a new category!";
          }
          else if(!preg_match("/^[a-zA-Z0-9 \-\_\&]+$/", $_POST['category']))
          {
            $errors['category'] = "Category cannot contain these special characters!";
          }
          else if(strlen($_POST['category']) > 32)
          {
            $errors['category'] = "Category can be no longer than 32 characters!";
          }
