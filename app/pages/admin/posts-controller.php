  <?php 
    ...
    if($action == 'add')
    {
        if(!empty($_POST))
        {
          ...
          else if(!preg_match("/^[a-zA-Z0-9 \-\_\&\!\?]+$/", $_POST['title']))
          {
            $errors['title'] = "Title cannot contain these sprecial characters!";
          }
          else if(strlen($_POST['title']) > 64)
          {
            $errors['title'] = "Title can be no longer than 32 characters!";
          }
          ...
          if(!empty($_FILES['image']['name']))
          {
            ...
            $errors['image'] = "Please add a featured image!";
          }
