<?php if($action == 'add'):?>
	...
	<div class="col-md-6 mx-auto">
	  <form method="post" enctype="multipart/form-data">
	    ...
	    <h1 class="h3 mb-3 fw-normal"><b>Add a new category</b></h1>
	    ...
	    <button class="mt-2 mb-5 btn btn-lg btn-primary float-end" type="submit">Create</button>
	...
	<div class="col-md-6 mx-auto">
	  <form method="post">
	    ...
	    <?php if(!empty($row)):?>
		    ...
		    <div class="form-floating">
            <div class="form-control my-2"><?=old_value('category', $row['category'])?></div>
            <label for="floatingInput">Category</label>
            </div>

            <div class="form-floating">
            <div class="form-control my-2"><?=old_value('slug', $row['slug'])?></div>
